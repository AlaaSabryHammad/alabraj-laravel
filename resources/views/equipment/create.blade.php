        ...
        <div class="flex items-center justify-between">
            <div>
                @if(isset($preselectedLocation) && $preselectedLocation)
                    ...
                    <p class="text-gray-600">إضافة معدة جديدة للموقع: <span class="font-semibold text-green-600">{{ $preselectedLocation->name }}</span></p>
                @else
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">إضافة معدة جديدة</h1>
        ...
        <form action="{{ route('equipment.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="manufacturer" class="block text-sm font-medium text-gray-700 mb-2">الشركة المصنعة</label>
                        <input type="text"
                               id="manufacturer"
                               name="manufacturer"
                    ...
                    <div>
                        <label for="serial_number" class="block text-sm font-medium text-gray-700 mb-2">الرقم التسلسلي *</label>
                        <input type="text"
                               id="serial_number"
                               name="serial_number"
                    ...
                    <div>
                        <label for="driver_id" class="block text-sm font-medium text-gray-700 mb-2">السائق المسؤول</label>
                        <select id="driver_id"
                                name="driver_id"
                    ...
                    <div>
                        <label for="location_id" class="block text-sm font-medium text-gray-700 mb-2">الموقع الحالي</label>
                        @if(isset($preselectedLocation) && $preselectedLocation)
                            <!-- Preselected Location (Read-only) -->
                            <div class="w-full px-4 py-3 border border-green-300 rounded-xl bg-green-50 text-green-900 font-medium flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <i class="ri-map-pin-line text-green-600"></i>
                                    <span>{{ $preselectedLocation->name }}</span>
                                    <span class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">محدد مسبقاً</span>
                                </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="purchase_date" class="block text-sm font-medium text-gray-700 mb-2">تاريخ الشراء *</label>
                        <input type="date"
                               id="purchase_date"
                               name="purchase_date"
                    ...
                    <div>
                        <label for="purchase_price" class="block text-sm font-medium text-gray-700 mb-2">سعر الشراء (ريال سعودي) *</label>
                        <input type="number"
                               id="purchase_price"
                               name="purchase_price"
                    ...
                    <div>
                        <label for="last_maintenance" class="block text-sm font-medium text-gray-700 mb-2">آخر صيانة</label>
                        <input type="date"
                               id="last_maintenance"
