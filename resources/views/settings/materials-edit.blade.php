            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="unit" name="unit" value="{{ old('unit', $material->unit) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="unit_of_measure" name="unit_of_measure" value="{{ old('unit_of_measure', $material->unit_of_measure) }}"
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" id="current_stock" name="current_stock" value="{{ old('current_stock', $material->current_stock) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" id="minimum_stock" name="minimum_stock" value="{{ old('minimum_stock', $material->minimum_stock) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" id="maximum_stock" name="maximum_stock" value="{{ old('maximum_stock', $material->maximum_stock) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="text" id="storage_location" name="storage_location" value="{{ old('storage_location', $material->storage_location) }}"
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="supplier_name" name="supplier_name" value="{{ old('supplier_name', $material->supplier_name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="supplier_contact" name="supplier_contact" value="{{ old('supplier_contact', $material->supplier_contact) }}"
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="model" name="model" value="{{ old('model', $material->model) }}"
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" id="unit_price" name="unit_price" value="{{ old('unit_price', $material->unit_price) }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="number" id="last_purchase_price" name="last_purchase_price" value="{{ old('last_purchase_price', $material->last_purchase_price) }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="date" id="last_purchase_date" name="last_purchase_date" value="{{ old('last_purchase_date', $material->last_purchase_date?->format('Y-m-d')) }}"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="4"
                              ...
                              placeholder="أدخل أي ملاحظات إضافية">{{ old('notes', $material->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
