    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="text-center">
                    <div class="text-3xl font-bold text-green-600">{{ $materials->where('is_active', true)->count() }}</div>
                ...
                <div class="text-center">
                    <div class="text-3xl font-bold text-red-600">{{ $materials->where('is_active', false)->count() }}</div>
