...
<head>
    ...
    <title>استعادة كلمة المرور - شركة الأبراج للمقاولات</title>
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="glass-effect rounded-2xl p-8 shadow-2xl">
            <div class="text-center mb-6">
                <h2 class="text-2xl font-bold text-white mb-2">استعادة كلمة المرور</h2>
                <p class="text-blue-100">أدخل بريدك الإلكتروني لتستلم رابط استعادة كلمة المرور</p>
            </div>
            ...
            @if ($errors->any())
                <div class="bg-red-500/20 border border-red-500/50 rounded-lg p-4 mb-6">
                    <div class="flex items-center gap-2 text-red-100">
                        ...
                        <span class="font-medium">خطأ في الطلب</span>
                    </div>
