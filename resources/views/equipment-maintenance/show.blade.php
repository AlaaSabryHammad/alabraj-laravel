...
@section('content')
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="lg:w-2/3">
            <!-- معلومات المعدة -->
            <div class="bg-white rounded-xl shadow-sm border mb-6 mr-4">
                <div class="p-6">
        ...
        <div class="lg:w-1/3">
            ...
            <!-- الإجراءات السريعة -->
            <div class="bg-white rounded-xl shadow-sm border mr-4">
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <form method="POST" action="{{ route('equipment-maintenance.destroy', $equipmentMaintenance) }}"
                            class="w-full">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
