            ...
            <div class="bg-white rounded-xl shadow-sm border p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="external_number" value="{{ old('external_number', $correspondence->external_number) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="subject" value="{{ old('subject', $correspondence->subject) }}" required
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    @if($correspondence->type === 'incoming')
                        ...
                        <div>
                            ...
                            <input type="text" name="from_entity" value="{{ old('from_entity', $correspondence->from_entity) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    @else
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="to_entity" value="{{ old('to_entity', $correspondence->to_entity) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="date" name="correspondence_date"
                               value="{{ old('correspondence_date', $correspondence->correspondence_date->format('Y-m-d')) }}" required
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="priority" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            <option value="low" {{ old('priority', $correspondence->priority) === 'low' ? 'selected' : '' }}>منخفضة</option>
                            <option value="medium" {{ old('priority', $correspondence->priority) === 'medium' ? 'selected' : '' }}>متوسطة</option>
                            <option value="high" {{ old('priority', $correspondence->priority) === 'high' ? 'selected' : '' }}>عالية</option>
                            ...
                            <div class="flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <label class="cursor-pointer text-green-600 hover:text-green-800">
                                        ...
                                        <input type="checkbox" name="replace_file" class="hidden" onchange="toggleFileUpload(this)">
                                    </label>
                                </div>
                            </div>
                    ...
                    <!-- File Upload -->
                    <div class="md:col-span-2" id="file-upload-section" style="{{ $correspondence->file_path ? 'display: none;' : '' }}">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
