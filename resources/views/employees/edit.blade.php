                ...
                <form action="{{ route('employees.update', $employee) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select id="department" name="department"
                                    ...
                                    <option value="الإدارة"
                                        {{ old('department', $employee->department) == 'الإدارة' ? 'selected' : '' }}>
                                        الإدارة</option>
                                    <option value="المالية"
                                        {{ old('department', $employee->department) == 'المالية' ? 'selected' : '' }}>
                                        المالية</option>
                                    <option value="الهندسة"
                                        {{ old('department', $employee->department) == 'الهندسة' ? 'selected' : '' }}>
                                        الهندسة</option>
                                    <option value="الموارد البشرية"
                                        {{ old('department', $employee->department) == 'الموارد البشرية' ? 'selected' : '' }}>
                                        الموارد البشرية</option>
                                    <option value="الصيانة"
                                        {{ old('department', $employee->department) == 'الصيانة' ? 'selected' : '' }}>
                                        الصيانة</option>
                                    <option value="المشاريع"
                                        {{ old('department', $employee->department) == 'المشاريع' ? 'selected' : '' }}>
                                        المشاريع</option>
                                    <option value="النقليات"
                                        {{ old('department', $employee->department) == 'النقليات' ? 'selected' : '' }}>
                                        النقليات</option>
                                </select>
                                @error('department')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" id="working_hours" name="working_hours"
                                    value="{{ old('working_hours', $employee->working_hours ?? 8) }}" step="0.5"
                                    min="1" max="24"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('working_hours') border-red-500 @enderror">
                                @error('working_hours')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            @if (auth()->user())
                                <div>
                                    ...
                                    <select id="status" name="status"
                                        ...
                                        <option value="active"
                                            {{ old('status', $employee->status) === 'active' ? 'selected' : '' }}>نشط
                                        </option>
                                        <option value="inactive"
                                            {{ old('status', $employee->status) === 'inactive' ? 'selected' : '' }}>غير نشط
                                        </option>
                                    </select>
                                    @error('status')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            @else
                                <!-- Hidden field to preserve existing status for non-admin users -->
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    @if ($employee->photo)
                                        <div class="mb-3">
                                            <img src="{{ asset('storage/' . $employee->photo) }}" alt="الصورة الحالية"
                                    ...
                                    @if ($employee->national_id_photo)
                                        <div class="mb-3">
                                            <img src="{{ asset('storage/' . $employee->national_id_photo) }}"
                                                alt="صورة الهوية الحالية" class="w-32 h-20 object-cover rounded border">
                                            <p class="text-xs text-gray-600 mt-1">الصورة الحالية</p>
                                        </div>
                                    @endif
                                    <input type="file" id="national_id_photo" name="national_id_photo"
                                        accept="image/*"
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <div>
                                                <label for="work_permit_issue_date"
                                                    class="block text-sm font-medium text-gray-700 mb-2">
                                                    تاريخ الإصدار
                                                </label>
                                                <input type="date" id="work_permit_issue_date"
                                            ...
                                            <div>
                                                ...
                                                <input type="date" id="work_permit_expiry_date"
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <input type="file" id="work_permit_photo" name="work_permit_photo"
                                            accept="image/*"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                </div>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" id="driving_license_issue_date"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label for="role" class="block text-sm font-medium text-gray-700 mb-2">
                                    الدور في النظام <span class="text-red-500">*</span>
                                </label>
                                ...
                                @error('role')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <p class="text-xs text-gray-500 mt-1">سيحدد هذا الدور الصلاحيات المتاحة للموظف في النظام
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="sponsorship_status" name="sponsorship_status"
                                    ...
                                    <option value="شركة الأبراج للمقاولات المحدودة"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'شركة الأبراج للمقاولات المحدودة' ? 'selected' : '' }}>
                                        شركة الأبراج للمقاولات المحدودة</option>
                                    <option value="فرع1 شركة الأبراج للمقاولات المحدودة"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'فرع1 شركة الأبراج للمقاولات المحدودة' ? 'selected' : '' }}>
                                        فرع1 شركة الأبراج للمقاولات المحدودة</option>
                                    <option value="فرع2 شركة الأبراج للمقاولات المحدودة"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'فرع2 شركة الأبراج للمقاولات المحدودة' ? 'selected' : '' }}>
                                        فرع2 شركة الأبراج للمقاولات المحدودة</option>
                                    <option value="مؤسسة فريق التعمير للمقاولات"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'مؤسسة فريق التعمير للمقاولات' ? 'selected' : '' }}>
                                        مؤسسة فريق التعمير للمقاولات</option>
                                    <option value="فرع مؤسسة فريق التعمير للنقل"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'فرع مؤسسة فريق التعمير للنقل' ? 'selected' : '' }}>
                                        فرع مؤسسة فريق التعمير للنقل</option>
                                    <option value="مؤسسة الزفاف الذهبي"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'مؤسسة الزفاف الذهبي' ? 'selected' : '' }}>
                                        مؤسسة الزفاف الذهبي</option>
                                    <option value="مؤسسة عنوان الكادي"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'مؤسسة عنوان الكادي' ? 'selected' : '' }}>
                                        مؤسسة عنوان الكادي</option>
                                    <option value="عمالة منزلية"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'عمالة منزلية' ? 'selected' : '' }}>
                                        عمالة منزلية</option>
                                    <option value="عمالة كفالة خارجية تحت التجربة"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'عمالة كفالة خارجية تحت التجربة' ? 'selected' : '' }}>
                                        عمالة كفالة خارجية تحت التجربة</option>
                                    <option value="أخرى"
                                        {{ old('sponsorship_status', $employee->sponsorship_status ?? '') == 'أخرى' ? 'selected' : '' }}>
                                        أخرى</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="category" name="category"
                                    ...
                                    <option value="A+"
                                        {{ old('category', $employee->category ?? '') == 'A+' ? 'selected' : '' }}>A+
                                    </option>
                                    <option value="A"
                                        {{ old('category', $employee->category ?? '') == 'A' ? 'selected' : '' }}>A
                                    </option>
                                    <option value="B"
                                        {{ old('category', $employee->category ?? '') == 'B' ? 'selected' : '' }}>B
                                    </option>
                                    <option value="C"
                                        {{ old('category', $employee->category ?? '') == 'C' ? 'selected' : '' }}>C
                                    </option>
                                    <option value="D"
                                        {{ old('category', $employee->category ?? '') == 'D' ? 'selected' : '' }}>D
                                    </option>
                                    <option value="E"
                                        {{ old('category', $employee->category ?? '') == 'E' ? 'selected' : '' }}>E
                                    </option>
                                </select>
                                @error('category')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select id="bank_name" name="bank_name"
                                    ...
                                    <option value="البنك الأهلي السعودي"
                                        {{ old('bank_name', $employee->bank_name) == 'البنك الأهلي السعودي' ? 'selected' : '' }}>
                                        البنك الأهلي السعودي</option>
                                    <option value="بنك الرياض"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك الرياض' ? 'selected' : '' }}>بنك
                                        الرياض</option>
                                    <option value="البنك السعودي للاستثمار"
                                        {{ old('bank_name', $employee->bank_name) == 'البنك السعودي للاستثمار' ? 'selected' : '' }}>
                                        البنك السعودي للاستثمار</option>
                                    <option value="البنك السعودي الفرنسي"
                                        {{ old('bank_name', $employee->bank_name) == 'البنك السعودي الفرنسي' ? 'selected' : '' }}>
                                        البنك السعودي الفرنسي</option>
                                    <option value="البنك السعودي البريطاني (ساب)"
                                        {{ old('bank_name', $employee->bank_name) == 'البنك السعودي البريطاني (ساب)' ? 'selected' : '' }}>
                                        البنك السعودي البريطاني (ساب)</option>
                                    <option value="بنك سامبا"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك سامبا' ? 'selected' : '' }}>بنك
                                        سامبا</option>
                                    <option value="البنك الأول"
                                        {{ old('bank_name', $employee->bank_name) == 'البنك الأول' ? 'selected' : '' }}>
                                        البنك الأول</option>
                                    <option value="مصرف الإنماء"
                                        {{ old('bank_name', $employee->bank_name) == 'مصرف الإنماء' ? 'selected' : '' }}>
                                        مصرف الإنماء</option>
                                    <option value="مصرف الراجحي"
                                        {{ old('bank_name', $employee->bank_name) == 'مصرف الراجحي' ? 'selected' : '' }}>
                                        مصرف الراجحي</option>
                                    <option value="بنك الجزيرة"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك الجزيرة' ? 'selected' : '' }}>بنك
                                        الجزيرة</option>
                                    <option value="بنك البلاد"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك البلاد' ? 'selected' : '' }}>بنك
                                        البلاد</option>
                                    <option value="البنك العربي الوطني"
                                        {{ old('bank_name', $employee->bank_name) == 'البنك العربي الوطني' ? 'selected' : '' }}>
                                        البنك العربي الوطني</option>
                                    <option value="مصرف آسيا"
                                        {{ old('bank_name', $employee->bank_name) == 'مصرف آسيا' ? 'selected' : '' }}>مصرف
                                        آسيا</option>
                                    <option value="بنك الخليج الدولي"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك الخليج الدولي' ? 'selected' : '' }}>
                                        بنك الخليج الدولي</option>
                                    <option value="بنك اتش اس بي سي السعودية"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك اتش اس بي سي السعودية' ? 'selected' : '' }}>
                                        بنك اتش اس بي سي السعودية</option>
                                    <option value="البنك الأهلي المصري"
                                        {{ old('bank_name', $employee->bank_name) == 'البنك الأهلي المصري' ? 'selected' : '' }}>
                                        البنك الأهلي المصري</option>
                                    <option value="بنك دويتشه السعودية"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك دويتشه السعودية' ? 'selected' : '' }}>
                                        بنك دويتشه السعودية</option>
                                    <option value="بنك الاتحاد"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك الاتحاد' ? 'selected' : '' }}>بنك
                                        الاتحاد</option>
                                    <option value="بنك مؤسسة النقد العربي السعودي"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك مؤسسة النقد العربي السعودي' ? 'selected' : '' }}>
                                        بنك مؤسسة النقد العربي السعودي</option>
                                    <option value="بنك التنمية الاجتماعية"
                                        {{ old('bank_name', $employee->bank_name) == 'بنك التنمية الاجتماعية' ? 'selected' : '' }}>
                                        بنك التنمية الاجتماعية</option>
                                    <option value="أخرى"
                                        {{ old('bank_name', $employee->bank_name) == 'أخرى' ? 'selected' : '' }}>أخرى
                                    </option>
                                </select>
                                @error('bank_name')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="iban" name="iban"
                                        value="{{ old('iban', $employee->iban) }}" placeholder="0000000000000000000000"
                                        maxlength="22"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <select id="nationality" name="nationality"
                                    ...
                                    <option value="سعودي"
                                        {{ old('nationality', $employee->nationality) == 'سعودي' ? 'selected' : '' }}>
                                        سعودي</option>
                                    <option value="مصري"
                                        {{ old('nationality', $employee->nationality) == 'مصري' ? 'selected' : '' }}>مصري
                                    </option>
                                    <option value="سوداني"
                                        {{ old('nationality', $employee->nationality) == 'سوداني' ? 'selected' : '' }}>
                                        سوداني</option>
                                    <option value="يمني"
                                        {{ old('nationality', $employee->nationality) == 'يمني' ? 'selected' : '' }}>يمني
                                    </option>
                                    <option value="سوري"
                                        {{ old('nationality', $employee->nationality) == 'سوري' ? 'selected' : '' }}>سوري
                                    </option>
                                    <option value="أردني"
                                        {{ old('nationality', $employee->nationality) == 'أردني' ? 'selected' : '' }}>
                                        أردني</option>
                                    <option value="لبناني"
                                        {{ old('nationality', $employee->nationality) == 'لبناني' ? 'selected' : '' }}>
                                        لبناني</option>
                                    <option value="فلسطيني"
                                        {{ old('nationality', $employee->nationality) == 'فلسطيني' ? 'selected' : '' }}>
                                        فلسطيني</option>
                                    <option value="عراقي"
                                        {{ old('nationality', $employee->nationality) == 'عراقي' ? 'selected' : '' }}>
                                        عراقي</option>
                                    <option value="باكستاني"
                                        {{ old('nationality', $employee->nationality) == 'باكستاني' ? 'selected' : '' }}>
                                        باكستاني</option>
                                    <option value="هندي"
                                        {{ old('nationality', $employee->nationality) == 'هندي' ? 'selected' : '' }}>هندي
                                    </option>
                                    <option value="بنغلاديشي"
                                        {{ old('nationality', $employee->nationality) == 'بنغلاديشي' ? 'selected' : '' }}>
                                        بنغلاديشي</option>
                                    <option value="فلبيني"
                                        {{ old('nationality', $employee->nationality) == 'فلبيني' ? 'selected' : '' }}>
                                        فلبيني</option>
                                    <option value="أخرى"
                                        {{ old('nationality', $employee->nationality) == 'أخرى' ? 'selected' : '' }}>أخرى
                                    </option>
                                </select>
                                @error('nationality')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select id="religion" name="religion"
                                    ...
                                    <option value="الإسلام"
                                        {{ old('religion', $employee->religion) == 'الإسلام' ? 'selected' : '' }}>الإسلام
                                    </option>
                                    <option value="المسيحية"
                                        {{ old('religion', $employee->religion) == 'المسيحية' ? 'selected' : '' }}>
                                        المسيحية</option>
                                    <option value="اليهودية"
                                        {{ old('religion', $employee->religion) == 'اليهودية' ? 'selected' : '' }}>
                                        اليهودية</option>
                                    <option value="الهندوسية"
                                        {{ old('religion', $employee->religion) == 'الهندوسية' ? 'selected' : '' }}>
                                        الهندوسية</option>
                                    <option value="البوذية"
                                        {{ old('religion', $employee->religion) == 'البوذية' ? 'selected' : '' }}>البوذية
                                    </option>
                                    <option value="السيخية"
                                        {{ old('religion', $employee->religion) == 'السيخية' ? 'selected' : '' }}>السيخية
                                    </option>
                                    <option value="أخرى"
                                        {{ old('religion', $employee->religion) == 'أخرى' ? 'selected' : '' }}>أخرى
                                    </option>
                                </select>
                                @error('religion')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select id="location_type" name="location_type"
                                    ...
                                    <option value="داخل المملكة"
                                        {{ old('location_type', $employee->location_type) == 'داخل المملكة' ? 'selected' : '' }}>
                                        داخل المملكة</option>
                                    <option value="خارج المملكة"
                                        {{ old('location_type', $employee->location_type) == 'خارج المملكة' ? 'selected' : '' }}>
                                        خارج المملكة</option>
                                </select>
                                @error('location_type')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            <label for="rating" class="block text-sm font-medium text-gray-700 mb-3">تقييم الأداء (من 1
                                إلى 5 نجوم)</label>
                            <div class="flex items-center gap-2">
                                <div class="star-rating" data-rating="{{ old('rating', $employee->rating ?? 0) }}">
                                    <input type="hidden" name="rating" id="rating"
                                        value="{{ old('rating', $employee->rating ?? '') }}">
                                            ...
                                            @foreach ($existingDocs as $doc)
                                                <li class="flex items-center gap-2 mb-1">
                                                    ...
                                                    @if (isset($doc['uploaded_at']))
                                                        <span
                                                            class="text-xs text-gray-400">({{ $doc['uploaded_at'] }})</span>
                                                    @endif
                                                </li>
                                            @endforeach
                                        </ul>
