                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select id="department"
                                ...
                                <option value="المالية" {{ old('department', $employee->department) == 'المالية' ? 'selected' : '' }}>المالية</option>
                                <option value="الهندسة" {{ old('department', $employee->department) == 'الهندسة' ? 'selected' : '' }}>الهندسة</option>
                                <option value="الموارد البشرية" {{ old('department', $employee->department) == 'الموارد البشرية' ? 'selected' : '' }}>الموارد البشرية</option>
                                <option value="الصيانة" {{ old('department', $employee->department) == 'الصيانة' ? 'selected' : '' }}>الصيانة</option>
                                <option value="المشاريع" {{ old('department', $employee->department) == 'المشاريع' ? 'selected' : '' }}>المشاريع</option>
                                <option value="النقليات" {{ old('department', $employee->department) == 'النقليات' ? 'selected' : '' }}>النقليات</option>
                            </select>
                            @error('department')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number"
                                   id="working_hours"
                                   name="working_hours"
                                   value="{{ old('working_hours', $employee->working_hours ?? 8) }}"
                                   step="0.5"
                                   min="1"
                                   max="24"
