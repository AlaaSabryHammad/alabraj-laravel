...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            <div class="profile-section">
                ...
                <div class="profile-details">
                    ...
                    <div
                        class="status-badge {{ $employee->status === 'active' ? 'status-active' : 'status-inactive' }}">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-value">{{ $employee->location ? $employee->location->name : 'غير محدد' }}
                            </div>
                        </div>
                        <div class="info-box">
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-value">
                                {{ $employee->hire_date ? $employee->hire_date->format('Y/m/d') : 'غير محدد' }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section">
            ...
            <div class="grid-4">
                ...
                <div class="info-box">
                    ...
                    <div class="info-value">
                        {{ $employee->salary ? number_format((float) $employee->salary) . ' ر.س' : 'غير محدد' }}</div>
                </div>
                <div class="info-box">
                ...
                <div class="grid-2">
                    ...
                    @if ($employee->iban)
                        <div class="info-box">
                            ...
                            <div class="info-value" style="font-family: monospace; font-size: 11px;">
                                SA{{ $employee->iban }}</div>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="footer-section">
            ...
            <div
                style="text-align: center; font-size: 11px; color: #666; margin-top: 15px; padding-top: 15px; border-top: 1px solid #ddd;">
